...
// Typed registry of known DimOS core topics — use with explicit type params
// (client.topic<DimosTopics["/odom"]>("/odom")) or compose your own map.
export type { DimosTopics, MsgClass } from "./topics";
