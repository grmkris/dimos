"""Headless aiortc client for the dimoscope /rtc endpoint (the gateway) — a browser stand-in that
connects, opens a DataChannel, and counts frames received over DUR seconds. Verifies the full path
(the gateway bus → /rtc DataChannel) e2e without a browser. Run with the gateway + bench_source up:
