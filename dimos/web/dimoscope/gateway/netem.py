...
PROFILES = [
    {"id": "clean", "label": "clean", "desc": "no shaping — the real path as-is (baseline)"},
    {
        "id": "wifi-normal",
        "label": "wifi-normal",
        "desc": "10mbit · 40±20ms · 0.3% loss — office Wi-Fi",
    },
    {
        "id": "wifi-crowded",
        "label": "wifi-crowded",
        "desc": "2mbit · 100±60ms · 1.5% bursty loss — conference/factory",
    },
    {
        "id": "wifi-edge",
        "label": "wifi-edge",
        "desc": "700kbit · 200±150ms · 5% bursty loss — robot far from AP",
    },
    {
        "id": "disaster",
        "label": "disaster",
        "desc": "200kbit · 500±300ms · 8% loss — degrade-gracefully test",
    },
    {
        "id": "loss-3",
        "label": "loss-3%",
        "desc": "100mbit · 40ms · 3% loss — HoL isolation (no bw cap)",
    },
    {
        "id": "loss-5",
        "label": "loss-5%",
        "desc": "100mbit · 40ms · 5% loss — HoL isolation (no bw cap)",
    },
]
OUTAGES = [
    ...
    {"id": "outage-udp-10s", "label": "UDP 10s", "desc": "drop QUIC/WT for 10s"},
    {
        "id": "outage-all-10s",
        "label": "all 10s",
        "desc": "drop TCP+UDP for 10s — full reconnect test",
    },
]
