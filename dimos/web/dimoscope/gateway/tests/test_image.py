...
# The python package imports without the native libturbojpeg — only the constructor finds out.
try:
    turbojpeg.TurboJPEG()
except Exception:
    pytest.skip("libturbojpeg native library unavailable", allow_module_level=True)
