...
all_blueprints = {
    ...
    "unitree-go2-agentic-gemini-rooms": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_agentic_gemini_rooms:unitree_go2_agentic_gemini_rooms",
    ...
    "unitree-go2-scan-agentic": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_scan_agentic:unitree_go2_scan_agentic",
...
all_modules = {
    ...
    "map-saver-skill": "dimos.agents.skills.map_saver_skill.MapSaverSkill",
    ...
    "room-manager": "dimos.agents.skills.room_manager.RoomManager",
    "room-scan-skill": "dimos.agents.skills.room_scan_skill.RoomScanSkill",
