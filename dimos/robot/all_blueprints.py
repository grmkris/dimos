...
all_blueprints = {
    ...
    "scope-arm": "dimos.web.dimoscope.scenarios.arm:scope_arm",
    "scope-cam": "dimos.web.dimoscope.scenarios.cam:scope_cam",
    "scope-nav": "dimos.web.dimoscope.scenarios.nav:scope_nav",
